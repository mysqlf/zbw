...
/***/ function(module, exports, __webpack_require__) {
	...
	var template = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"art-template\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));// 模版引擎使用
	
	if(true){
		// http://mockjs.com/
		// 只有不是开发环境 才使用 mock模拟ajax
		__webpack_require__(/*! mockData/demo.js */ 1);
	}
	...
	$.ajax({
		...
		success: function(data){
			var html = template.render(__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"tpl/demo.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).template)(data);
	...
	// 验证表单插件
	// 需要更改 源文件 638行 解决相同name值问题 但是id必须唯一
	/*
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"jquery-validation\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	$('#add').click(function(){
	
		var html = template.render($('#tpl').html())({index:$('[name="name[]"]').length});
		$('#add').before(html);
	})
...
/* 1 */
/*!*********************************!*\
  !*** ./js/src/mockData/demo.js ***!
  \*********************************/
/***/ function(module, exports, __webpack_require__) {

	var Mock = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"mockjs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	ready.run = function(){
	    ...
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./skin/layer.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
