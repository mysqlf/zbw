...
class DocumentModel extends Model{
	...
	/**
	 * [getArticleLocation 获取平台文章地址]
	 * @return [type] [description]
	 */
	public function getArticleLocation(){
		$result=$this->field('location')->where(array('location'=>array('gt',0)))->group('location')->select();
		return $result;
	}
	/**
	 * 返回前一篇文档信息
	...
	/**
	 * [getLocation 获取文章中所有地区]
	 * @return [array] [description]
	 */
	public function getLocation()
	{
		$map = 'location <> 0 and location is not null and status =1 and category_id in(2,5,6,11)';
