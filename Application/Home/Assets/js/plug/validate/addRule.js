...
// 总是失败 当使用showError 时 控制表单提交
jQuery.validator.addMethod("fail", function(value, element) {   
...
$.validator.setDefaults({
	...
	errorPlacement: function(error,element) {
		if(element.attr('type') == 'radio' || element.attr('type') == 'checkbox' || element.hasClass('hidden-txt') || element.hasClass('J_select2')){
